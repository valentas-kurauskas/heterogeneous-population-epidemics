...
In the terminology of graph theory the first chart shows the giant component size as a function of the largest degree *b* on the while other parameters, including R0, which is the expectation of size-biased degree distribution *E D^2/E D - 1*, are kept fixed.
